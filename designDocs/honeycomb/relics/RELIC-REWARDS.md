...
entirely (`RELICS.md` P2): for a Brienne-and-Cinder party, twelve relics it should never have offered
were on its table.
...
3. **The relic economy got tighter this session, twice.** Ordinary fights stopped paying relics and
   chests were capped at three a region (`../engine/ENGINE.md` P11 and P13). Adding six relics to the pool
