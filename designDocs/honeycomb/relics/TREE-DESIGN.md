...
- `../Archive/demo1/rework/progression/PROGRESSION-LIST.md` — the topology decisions and the six intended silhouettes.
- `../relics/STARTER-LIST.md` — the per-character node content.
...
| S7 | **Cost curve.** Cost follows a node's VALUE, not its depth (Noodle, `../Archive/demo1/rework/progression/TREE-EXP-MATH.md` §4) — a cheap late node or a pricey early one is deliberate, so this is informational only. | The old "rises with depth" reading contradicts the agreed tiers. |
...
From `../Archive/demo1/rework/progression/PROGRESSION-LIST.md` §2. These are **targets, not constraints**: they tell an author which way
...
3. **Save file** (or copy the **Skeleton** text). That JSON is the ground truth for the shape. Saved
   ...
   `../Archive/demo1/rework/progression/TREE-SIZE-REFERENCE.md`.
...
8. Look at it in the browser (`../tools/agent-browser.js`) and react to the shape, per `../Archive/demo1/rework/progression/PROGRESSION-LIST.md`
