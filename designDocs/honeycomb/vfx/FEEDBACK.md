...
Card and combat visual effects.

**B21 raised the stakes on this workstream**: the enemy art plan explicitly assumes "vfx will do the rest of the work", so hit feedback now depends on VFX rather than on sprites.
