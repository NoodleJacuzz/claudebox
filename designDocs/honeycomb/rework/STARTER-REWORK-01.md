...
Working lists: **`starters/STARTER-LIST.md`**, **`starters/OUTFITS-LIST.md`**, **`starters/RELICS-LIST.md`**. Quotes below are Noodle's and win. Do not implement until those lists are agreed.

Live pool is unchanged. Strip-defaults (Nettle auto-back, starter upgrades, A1 from start): `../Archive/FEEDBACK-07.md` § G.
...
moved to a node in `starters/STARTER-LIST.md`. Cinder self-Vulnerable is printed +1 extra so one stack
...
Live node list: `starters/STARTER-LIST.md`. +Agg/−Agg and +Def/−Def are exclusive families there. Random-common
...
| Opening card/energy | Exclusive family (`starters/STARTER-LIST.md`) |
| Survive-lethal, Super Exhaust | Relic |
| Innate | Dropped (5-card start) |
| Starting gold | Node |
| Bounty, shop, rest efficiency | Exclusive families (`starters/STARTER-LIST.md`) |
