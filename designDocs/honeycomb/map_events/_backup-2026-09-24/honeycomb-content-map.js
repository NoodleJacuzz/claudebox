...
honeycomb.eventArray = [
	...
	//-------------------------------------------------------------------------------------------
	{
		...
		weight: 55,
		text: "Water comes out of the rock too warm to be groundwater. A woman is already in it, and she shifts " +
			"over to make room. Whoever is having the worst of it can barely be talked past the edge.",
		imagePath: "events/spring",
		choiceArray: [
			{
				index: "bathe",
				discovery: true,
				...
				resultText: "They come out steadier. Afterwards the coins are gone from your purse, and so is " +
					"the woman.",
			},
			{
