# Root FEEDBACK.md — what was routed and closed, up to 2026-09-25

**ARCHIVED 2026-09-25.** Moved byte for byte out of the root `../FEEDBACK.md`, which holds only an index
and an inbox. Three things are here: the session-39 top-priority note and the session-38 demo gate table
(the FIRST demo, which shipped as the Public Test Release on 2026-09-23; the second demo's gate is
`../BASICS.md`), the closed cross-cutting item B20, and the routing tables for every batch of reports
filed between 2026-09-21 and 2026-09-23. Every report they name was filed into a workstream and worked
there; the six playtest decisions the tables call open were all answered and built in sessions 55b to
55d (`playtest_55/READ-ME-2.md` to `READ-ME-4.md`, beside this file).
